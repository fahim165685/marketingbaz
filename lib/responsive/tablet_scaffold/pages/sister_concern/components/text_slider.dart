  ...
  Widget build(BuildContext context) {
    return RichText(
      ...
      text: TextSpan(
          children: [
            //Title
            TextSpan(text: title2,style:const TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kPrimaryLightColor)),
            TextSpan(text: title,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kTextLightColor)),
