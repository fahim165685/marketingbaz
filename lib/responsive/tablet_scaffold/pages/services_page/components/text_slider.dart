...
class BuildRichText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AutoSizeText.rich(
      TextSpan(children: [
              TextSpan(text: title2,style:const TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: kPrimaryLightColor)),
              TextSpan(text: title,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: kTextLightColor)),
              TextSpan(text: description,style: TextStyle(fontSize: Get.width*0.02,fontWeight: FontWeight.w400,color: kTextLightColor.withOpacity(0.5))),
      ]),
    );
  }
}
